...
Read1="/well/mccarthy/users/jason/projects/wtsa/promoter_driven/fastq_files/EndoBA_R1.fastq.gz"
Read2="/well/mccarthy/users/jason/projects/wtsa/promoter_driven/fastq_files/EndoBA_R2.fastq.gz"
