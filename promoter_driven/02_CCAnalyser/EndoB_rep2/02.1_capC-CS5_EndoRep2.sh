...
Read1="/well/mccarthy/users/jason/projects/wtsa/promoter_driven/fastq_files/EndoBC_R1.fastq.gz"
Read2="/well/mccarthy/users/jason/projects/wtsa/promoter_driven/fastq_files/EndoBC_R2.fastq.gz"
