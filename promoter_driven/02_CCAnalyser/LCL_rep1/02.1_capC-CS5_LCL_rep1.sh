...
Read1="/well/mccarthy/users/jason/projects/wtsa/promoter_driven/fastq_files/BlymphA_R1.fastq.gz"
Read2="/well/mccarthy/users/jason/projects/wtsa/promoter_driven/fastq_files/BlymphA_R2.fastq.gz"
