...
> save_peakc_diff_plots(gene.vec,abscutoff=10)
[1] "ADCY5"
Joining, by = "V2"
  chrom     start       end                         name
1  chr3 123065778 123065778 rs11708067_T2D_FG_HOMAB_2hrG
  chrom     start       end             name
2  chr3 123065778 123065778 rs11708067_ADCY5
[1] "DGKB"
Joining, by = "V2"
[1] "AP3S2"
Joining, by = "V2"
...
Joining, by = "V2"
  chrom    start      end           name
1 chr10 12307894 12307894 rs11257655_T2D
  chrom    start      end              name
2 chr10 12309268 12309268 rs11257658_CAMK1D
[1] "MADD"
Joining, by = "V2"
  chrom    start      end                  name
1 chr11 47293799 47293799 rs10501320_FG_FproIns
[1] "STARD10"
Joining, by = "V2"
[1] "NKX6-3"
Joining, by = "V2"
  chrom    start      end                                  name
1  chr8 41509259 41509259 rs12549902_Corrected_insulin_response
  chrom    start      end             name
2  chr8 41509915 41509915 rs4736819_NKX6-3
[1] "WARS"
Joining, by = "V2"
  chrom     start       end         name
1 chr14 100839261 100839261 rs3783347_FG
  chrom     start       end           name
2 chr14 100832282 100832282 rs2146105_WARS



> save_peakc_diff_plots(gene.vec,abscutoff=100)
[1] "ADCY5"
Joining, by = "V2"
[1] "DGKB"
Joining, by = "V2"
