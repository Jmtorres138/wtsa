...
#$ -N e2_capcom
#$ -q short.qc
#$ -o /well/mccarthy/users/jason/projects/wtsa/enhancer_driven/second_round/logs/capture-compare.out
#$ -e /well/mccarthy/users/jason/projects/wtsa/enhancer_driven/second_round/logs/capture-compare.err
#$ -pe shmem 1
...
path="/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/second_round/02_CCAnalyser/"
