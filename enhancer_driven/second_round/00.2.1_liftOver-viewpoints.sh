WORKDIR=/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/second_round
INDIR=$WORKDIR/input_files
INFILE=$INDIR/Oligo-file_merged_GRCh37.txt
...
paste $INDIR/col1.txt $INDIR/temp1.38.bed $INDIR/temp2.38.bed $INDIR/col8.txt $INDIR/col9.txt > $INDIR/Oligo-file_merged_GRCh38.txt
