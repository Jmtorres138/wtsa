...
cur_dir = "/t1-data/user/hugheslab/jtorres/wtsa/enhancer_driven/second_round/"

oligofile_path = cur_dir + "OligoFile.txt"
pub_path = "/public/jtorres/wtsa/enhancer_driven/second_round/"
blatdir_path = cur_dir + "BlatPloidyFilterRun/REUSE_blat"
