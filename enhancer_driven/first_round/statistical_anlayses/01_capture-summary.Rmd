...
ggsave(plot=tot.plt,filename=plot.dir%&%"summary_counts_enh1st.png",width=3.5,height=5)
ggsave(plot=tot.plt,filename=plot.dir%&%"summary_counts_enh1st.pdf",width=3.5,height=5)
...
tot.plt <- total.count.plot(prom.df,yscale="10K",
                            input.vec=c("EndoBA","EndoBC","EndoBD"))#,
                                 #"BlymphA","BlymphB","BlymphC"))
ggsave(plot=tot.plt,filename=plot.dir%&%"summary_counts_prom.png",width=3.5,height=5)
ggsave(plot=tot.plt,filename=plot.dir%&%"summary_counts_prom.pdf",width=3.5,height=5)
