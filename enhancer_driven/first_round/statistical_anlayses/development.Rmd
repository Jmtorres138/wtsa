...
plt1 <- capc_plot(bdg.df=bdg.df,d=plt.list[[1]],to.exclude=plt.list[[2]],
                 params=plt.list[[3]], peakc.res=peakc.res, plotwin=500000)

plt2 <- gene_plot(plt.list[[3]],plotwin=500000)

plt3 <- credset_plot(plt.list[[3]],plotwin=500000)

tracks(plt1,plt3,plt2,heights=c(2,0.5,1))
