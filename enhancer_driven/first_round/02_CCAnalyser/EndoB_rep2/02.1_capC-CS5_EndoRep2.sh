...
Read1="/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/first_round/fastq_files/combined/Endo_B_R1.combined.fastq.gz"
Read2="/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/first_round/fastq_files/combined/Endo_B_R2.combined.fastq.gz"
...
OligoFile="/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/first_round/input_files/Oligo-file_merged_GRCh38_no-chr.txt"


# This is the path to the public folder we want to put the data into (this folder can exist, but it does not need to) :

PublicPath="/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/first_round/public/"
...
Blatpath="/well/mccarthy/users/jason/projects/wtsa/enhancer_driven/first_round/01_REUSE_blat/"
