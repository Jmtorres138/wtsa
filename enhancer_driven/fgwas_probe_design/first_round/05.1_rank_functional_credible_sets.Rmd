...
plot.df <- select(keep.df,one_of("refGene","gcred.locus","irp","endo.atac","eqtls.ld20","dimas.wood","num.snps","tier"))
...
ggsave(plot=plt,filename=work.dir%&%"first-round-keep.table.pdf",height=20,width=20)

plot.df2 <- select(remainder.df,one_of("refGene","gcred.locus","irp","endo.atac","eqtls.ld20","dimas.wood","num.snps"))
...
ggsave(plot=plt2,filename=work.dir%&%"first-round-remainder.table.pdf",height=20,width=20)
