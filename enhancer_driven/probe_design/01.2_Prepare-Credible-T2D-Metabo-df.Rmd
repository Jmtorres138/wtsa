...
input.dir <- serv.dir %&% "projects/t2d-integration/fgwas/metabochip/"
...
cred.df <- fread(input.dir%&%"intermediate_files/metabo-fgwas-core.txt") %>% dplyr::select(one_of("SNPID","CHR","POS","SEGNUMBER","PPA","LOCUS"))

fgwas.outfile <- input.dir%&%"fgwas_output/" %&% "intron+utr_3-p0.05.bfs.gz"
...
saveRDS(cred.df,file=rds.dir%&%"credmetab.df.RDS")
