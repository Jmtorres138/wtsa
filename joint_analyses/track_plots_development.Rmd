...
capture_plot <- function(exp.type,cap.name,cc.df){
  ...
  obj3 <- readRDS(save.dir %&% exp.type %&% "_" %&% cap.name %&% "_knownGenes.RDS")
  p1 <- obj1[[1]] 
  p2 <- obj2[[1]]
  p3 <- obj2[[2]] 
...
# cannot plot "GNPDA2__32DF__uc__chr4_44996579", gene plot range issue 
# cannot plot "chr13_58953476_PCDH17", gene plot range issue 
# cannot plot ""chr4_137094047_PABPC4L"", gene plot range issue 
