...
write.table(x=e2.df,file=output.dir%&%"enhancer-secondRound_DESeq2-interactions.txt",
            sep="\t",quote=F,row.names=F)
write.table(x=e2.list[[1]],file=output.dir%&%"enhancer-secondRound_DESeq2-output.txt",
            sep="\t",quote=F,row.names=F)
```
