...
e2.df <- fread(input.dir %&% "enhancer2nd_endo_peaky-interactions.txt")
e2.full.df <- fread(input.dir %&% "enhancer2nd_endo_peaky-output.txt")
```
...
write.table(x=e2.list[[1]],file=output.dir %&% 
              "enhancer2nd_endo_peaky-interactions.bed",sep="\t",row.names=F,
            col.names=F,quote=F)
write.table(x=e2.list[[2]],file=output.dir %&% 
              "enhancer2nd_endo_peaky-interactions_rjmcmc-pos.bedGraph",sep="\t",row.names=F,
            col.names=F,quote=F)
```
...
./bedToBigBed promoter_endo_peaky-interactions.sorted.bed hg19.chrom.sizes promoter_endo_peaky-interactions.bb
```

```{bash}
sort -k1,1 -k2,2n enhancer2nd_endo_peaky-interactions.bed > enhancer2nd_endo_peaky-interactions.sorted.bed 
./bedToBigBed enhancer2nd_endo_peaky-interactions.sorted.bed  hg19.chrom.sizes enhancer2nd_endo_peaky-interactions.bb
```
...
./bedGraphToBigWig promoter_endo_peaky-interactions_rjmcmc-pos.sorted.bedGraph hg19.chrom.sizes promoter_endo_peaky-interactions_rjmcmc-pos.bw
...
./bedGraphToBigWig promoter_endo_peaky-interactions_residual.sorted.bedGraph hg19.chrom.sizes promoter_endo_peaky-interactions_residual.bw
```

```{bash}
sort -k1,1 -k2,2n enhancer2nd_endo_peaky-interactions_rjmcmc-pos.bedGraph > enhancer2nd_endo_peaky-interactions_rjmcmc-pos.sorted.bedGraph 
./bedGraphToBigWig enhancer2nd_endo_peaky-interactions_rjmcmc-pos.sorted.bedGraph hg19.chrom.sizes enhancer2nd_endo_peaky-interactions_rjmcmc-pos.bw
```
