...
library("data.table")
setwd("/well/mccarthy/users/jason/projects/wtsa/joint_analyses/coloc_analysis_files/rasqual_output")

for (i in seq(19,22,1)){
	print("Chromosome: " %&% i)
	INFILE<-paste("results_rasqual_chr",paste(i,".txt.gz",sep=""),sep="")
	OUTFILE<-paste("results_rasqual_chr",paste(i,"_with_Pvalues.txt",sep=""),sep="")
